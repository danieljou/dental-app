...
import { NeuralNetworkBackground, OrderSummary, PaymentSuccessModal, ProgressSteps } from '@/components/cart';
                ...
                <div className="mb-12 text-center animate-fade-in">
                    <div className="mx-auto">
                        ...
                        <p className="text-xl text-neutral-600 dark:text-neutral-400 mb-8 animate-slide-up" style={{ animationDelay: '0.2s' }}>
                            Finalisez votre commande avec notre système de paiement sécurisé et intelligent
                        </p>
