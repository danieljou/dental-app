...
const ProductCard: React.FC<ProductCardProps> = ({ product, onArClick, showQuickPreview }) => {
    ...
    return (
        ...
        >
            <div className="card-inner flex flex-col h-full"> {/* Added flex-col h-full */}
                ...
                in a real app, you'd map React components here */}
                    ...
                    <div className="absolute inset-x-6 bottom-6 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500 z-10">
                        <button
                            onClick={() => showQuickPreview(product.id)}
                            className="morph-button ripple w-full bg-white/95 dark:bg-neutral-800/95 backdrop-blur-sm text-neutral-900 dark:text-white font-semibold py-4 rounded-2xl hover:bg-white dark:hover:bg-neutral-800 transition-all shadow-float hover:shadow-glow hover:scale-105"
                        >
                ...
                <div className="p-8 flex-grow flex flex-col"> {/* Added flex-grow flex flex-col */}
                    ...
                    <div className="flex items-end justify-between mt-auto"> {/* Added mt-auto to push to bottom */}
                            ...
                            <div className="flex items-center gap-2">
                                {product.fastDelivery && (
                                    <span className="text-xs text-green-600 dark:text-green-400 font-semibold flex items-center">
                                        <i className="fas fa-shipping-fast mr-1"></i>Livraison rapide
                                    </span>
                                )}
                                {product.inStock && (
